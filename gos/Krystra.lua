...
GetWebResultAsync("https://raw.githubusercontent.com/Lonsemaria/Gos/master/Version/midbundle.version", AutoUpdate)
 ...
 local ebuff = false
    ...
    function Viktor:__init()
      ...
      self.W = { delay = 0.60, speed = 750, width = 125, range = 700 , radius = 250 } --AOE true , Col false
      self.E = { delay = 0.25, speed = 1200 , width = 650, range = 1200 } --AOE false , Col false
      self.R = { delay = 0.25, speed = 1000, width = 700 range = 700 , radius = 325 } --AOE true , Col false
      self:LoadMenu()
      ...
      self.tsg = TargetSelector(1300,TARGET_LESS_CAST_PRIORITY,DAMAGE_MAGIC,true,false)
        ...
        wSpell  = IPrediction.Prediction({range = 700, speed = 750, delay = 0.60, width = 125, type = "circular",name =myHero:GetSpellData(_W).name,  collision = false})
...
function Leblanc:__init()
        if not libloaded then return end
  self.Q = {  range = 700 }
  self.W = { delay = 0.25, speed = 1300, width = 125, range = 600 , radius = 250 } --AOE true , Col false
